...
public class ViewEmpFrame extends javax.swing.JFrame {
    ...
    private void showEmpData(){
        ...
        DefaultTableModel dts=(DefaultTableModel)jtEmpData.getModel();
        ...
        dts.addRow(rows);
            ...
            JOptionPane.showMessageDialog(null,"DBError","Exception",JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    //coding here see  photo date 7/1/20 
